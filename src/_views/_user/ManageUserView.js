...
import {
    updateUser} from '../../_actions/userActions'
...
function ManageUserView(props)
{
    ...
    const user = props.users.find(p=> {return p.id == params.userId});
    ...
    function onChange(e)
    {
      ...
      reader.onload = (e)=>{
        ...
        let newCurrentUser = {...currentUser, profilePictureUrl:e.target.result};
      ...
      /* for (var index = 0; index < files.length; index++) {
        ...
        //axios.post(BaseURL + '/users/profilepicture', form, {headers:{'Access-Control-Allow-Origin': '*',
        //Authorization: 'Bearer '+ props.currentUser.token}})         
        axios.post(BaseURL + '/api/files/upload', form, config)
                .then((result) => {
    ...
    function userAvatar()
    {
      ...
      {
        return <Avatar alt="Remy Sharp" src={currentUser.profilePictureUrl} className={classes.bigAvatar} />
    ...
    return(
      ...
      <Grid justify="center" container
        ...
        justify="flex-start"
        alignItems="center">
          <Button variant="outlined"  component={Link} to={ "/setup/users/"} color="primary">
              Back
          </Button>
          <Button style={{marginLeft:5}} variant="contained" onClick={updateProfile} color="primary">
              Update
          </Button>
      </Grid>
      <Grid justify="center" container
...
export default withSnackbar(connect(mapStateToProps, mapDispatchToProps)(ManageUserView));