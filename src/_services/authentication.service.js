...
function login(companyIdentifier, username, password, isRememberMe = true) {
        ...
        .then(response =>
            {
                ...
                if (response.request.status != 200) {
                    ...
                    const error = (response.request.data && response.request.data.message) || response.request.statusText;
